...
class ChargeEthLog extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "全部",
  ...
  async onHeaderRefresh() {
    ...
    let res = await Axios.get(
      "/wallet/deposits?page=0&size=10&startDate=" +
    ...
    return (
      <View style={styles.loglist}>
        <View style={styles.lineCom}>
          <Text style={styles.txtName}>充值时间：</Text>
          <Text style={styles.txtInfo}>{data.item.createTime}</Text>
        </View>
        <View style={styles.lineCom}>
          <Text style={styles.txtName}>充值数量：</Text>
          <Text style={[styles.txtInfo, styles.txtNum]}>
            {new BigNumber(data.item.eth).toFormat()}
            ETH
          </Text>
        </View>
        <View style={styles.lineCom}>
          <Text style={styles.txtName}>充值hash：</Text>
          <Text style={styles.txtInfo}>{data.item.txId}</Text>
        </View>
        <View style={styles.lineState}>
          <Text style={styles.txtState}>充值成功</Text>
        </View>
      </View>
    );
  };
        ...
        <View style={styles.top}>
          ...
          >
            <View style={styles.nav}>
              ...
              <Text style={styles.titleM}>充值明细ETH</Text>
